...
import { Upload, FileSearch, FileText, CheckCircle, Settings, LucideIcon } from 'lucide-react';
...
const HowItWorksTsx: React.FC = () => {
  const firstRowItems: ProcessItem[] = [
    {
      icon: Upload,
  ...
  const secondRowItems: ProcessItem[] = [
    {
      icon: Settings,
