    ...
    <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-black/30 backdrop-blur-sm border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold text-white mb-4">UpResume</h3>
            <p className="text-gray-400 mb-6">Create professional resumes that get you hired.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/examples" className="text-gray-400 hover:text-white">Examples</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">© 2023 UpResume. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
