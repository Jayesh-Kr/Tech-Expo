      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Start Your Free Trial Today And Experience Decentralized Website Monitoring. Transform Your Uptime Strategy With Our Blockchain-Powered Platform Designed To Maximize Reliability
          </p>
